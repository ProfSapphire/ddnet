...
MACRO_CONFIG_STR(ClOllamaPersonaName, cl_ollama_persona_name, 64, "Teebot", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Visible persona name used in Ollama prompts and outgoing chat text")
MACRO_CONFIG_STR(ClOllamaLogFile, cl_ollama_log_file, 128, "ollama-chat.jsonl", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Relative save-path JSONL log file for Ollama requests; empty disables logging")
MACRO_CONFIG_INT(ClOllamaMood, cl_ollama_mood, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable hidden session-only mood tracking for Ollama replies")
MACRO_CONFIG_INT(ClOllamaIdleChatter, cl_ollama_idle_chatter, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Allow Ollama to send unsolicited idle chatter based on recent public chat")
MACRO_CONFIG_INT(ClOllamaIdleSeconds, cl_ollama_idle_seconds, 90, 15, 600, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Silence threshold and cooldown in seconds before idle chatter may trigger")
MACRO_CONFIG_INT(ClOllamaPlayerMemory, cl_ollama_player_memory, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable per-player session memory for Ollama replies")
MACRO_CONFIG_INT(ClOllamaMapContext, cl_ollama_map_context, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Inject the current map name into generated Ollama runtime prompts")
MACRO_CONFIG_INT(ClOllamaLanguageHint, cl_ollama_language_hint, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Inject detected-language guidance into generated Ollama runtime prompts")
